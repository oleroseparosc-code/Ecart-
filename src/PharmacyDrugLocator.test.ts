...
const drugs: LocatorDrug[] = [
  ...
  { code: "XRAMOSET", itemCode: "8806809002427", name: "Nasea 0.3mg/2ml inj", koreanName: "나제아주사액", strength: ".3 mg", drugType: "앰플", storage: "실온" },
];
...
describe("PharmacyDrugLocator", () => {
  it("shows preparation notes below cautions for MMR and injectable Nasea", () => {
    ...
    expect(preparationNotes(drugs[1])).toEqual(["니들 필요"]);
  });
